...
private:
  ...
  // Geometric Constants
  static constexpr double lox_ = 0.033;
  static constexpr double loz_ = 0.1472;
  static constexpr double l_2_ = 0.155;
  static constexpr double l_3_ = 0.135;
  static constexpr double l_4_ = 0.218; // Including sensor carrier which is 1.5mm thick
